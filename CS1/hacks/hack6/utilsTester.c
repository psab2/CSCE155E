...
int main(int argc, char **argv) {
    ...
    double myTest1[] =          { 111, 235, 64, 0.528, 0.000, 0.728, 0.078};
    double myTest2[] =          { 3, 203, 127, 0.985, 0.000, 0.374, 0.204};
    double myTest3[] =          { 230, 197, 192, 0.000, 0.143, 0.165, 0.098};
    ...
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test_prestate(testBidirectionalValues, &myTest1),
            cmocka_unit_test_prestate(testBidirectionalValues, &myTest2),
            cmocka_unit_test_prestate(testBidirectionalValues, &myTest3)
  };
